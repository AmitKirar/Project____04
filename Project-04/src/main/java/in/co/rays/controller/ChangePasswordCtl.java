...
/**
 * ChangePasswordCtl allows a user to change their password. It validates the
 * input, checks the old password, and updates the new password in the database.
 * <p>
 * Accessible via `/ChangePasswordCtl` URL.
 * </p>
 * 
 * @author Amit
 * @version 1.0
...
public class ChangePasswordCtl extends BaseCtl {
	...
	/**
	 * Validates the password change input fields.
	 * 
	...
	/**
	 * Populates UserBean with old and confirm password values from the request.
	 * 
	 * @param request the HTTP request
	...
	/**
	 * Handles HTTP POST request. It performs password change operation or redirects
	 * to profile.
	 * 
	 * @param request  the HTTP request
	 * @param response the HTTP response
	 ...
	 * 
	 * @return path to CHANGE_PASSWORD_VIEW
	 */
